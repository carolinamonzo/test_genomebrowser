...
- **Isoform names (text box):** Default wildcard `*` shows all. For a list: switch to regexp, paste pipe-separated IDs (e.g., `PB[.]1[.]1|PB[.]2[.]3`). Use "Generate Filter String" in the HTML tables.
